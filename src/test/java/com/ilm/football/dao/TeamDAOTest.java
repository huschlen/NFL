...
public class TeamDAOTest {
	...
	public void testGetTeamById() {
		...
		team.setAverage(3);
		team.setRound1Score(3);
		team.setRound2Score(0);
	...
	public void testGetAllTeams() {
		...
		team1.setAverage(3);
		team1.setRound1Score(3);
		team1.setRound2Score(0);
		...
		team2.setAverage(25);
		team2.setRound1Score(3);
		team2.setRound2Score(0);
	...
	public void testUpdateTeam() {
		...
		existingTeam.setRound1Score(3);
		existingTeam.setRound2Score(0);
